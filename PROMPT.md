...
- `/admin/payroll-map` — **จับคู่รหัสเงินเดือน**: คีย์รหัสจากระบบ payroll ให้พนักงานแต่ละคน
  หรือวางข้อมูลจาก Excel แล้วให้ระบบจับคู่ตามชื่อ · รายงานทุกแบบแสดงรหัสทั้งสองชุด
- รายงานรายวัน/รายเดือน มีช่อง **จัดกลุ่ม** แยกตามสาขา หรือแยกตามบริษัท พร้อมยอดรวมของแต่ละกลุ่ม
- `/admin/wall` — **จอ War Room ลงเวลา** เปิดค้างบนจอมอนิเตอร์ รีเฟรชเองทุกนาที: กล่องสรุปของวัน,
  รายชื่อที่ต้องตาม (ยังไม่มา/สาย/ออกธุระ/งานนอกสถานที่), เทียบตามสาขา-บริษัท-แผนก-ตำแหน่ง, แนวโน้ม 14 วัน
- รายงานรายวัน: กล่องสรุป (ลงเวลาไม่ครบ/ขาดงาน/มาสาย/พักเกิน) คลิกกรองได้ · คลิกชื่อพนักงานไปหน้าแก้เวลาย้อนหลัง
- `/admin/records/...` และหน้ารายงาน เปิดให้ผู้มีสิทธิ์รายเมนูเข้าได้โดยไม่ต้องใช้ PIN
  (เมนู ATT_RECORDS: อ่าน=ดู · เพิ่ม/แก้ไข=แก้เวลา · ลบ=ลบรายการ) กำหนดสิทธิ์ที่ระบบส่วนกลาง
