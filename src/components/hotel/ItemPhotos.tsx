...
const ENDPOINT = "/api/hotel/photo";
const MAX_EDGE = 1600;
...
/**
 * รูปประกอบของรายการตรวจเช็คหนึ่งข้อ — กดแล้วเปิดกล้องบนมือถือได้เลย
      ...
      {zoom && (
        ...
        >
          <div className="max-h-full w-full max-w-2xl overflow-auto rounded-xl bg-white p-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={photoUrl(zoom)} alt="รูปประกอบการตรวจเช็ค" className="w-full rounded-lg" />
