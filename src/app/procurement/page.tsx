...
const CARDS: { href: string; menuCode: string; title: string; desc: string }[] = [
  ...
  { href: "/procurement/fund-payments", menuCode: "PR_FUND_PAY", title: "4.4 จ่ายเงินจากเงินสำรอง", desc: "จ่ายออกจากวงเงินสำรองที่ผู้ถือเงินถือไว้ ระบบตัดยอดคงเหลือให้อัตโนมัติ" },
  { href: "/procurement/fund-topups", menuCode: "PR_FUND_TOPUP", title: "4.5 เติมเงินสำรองจ่าย", desc: "เติมเงินเข้ากอง คืนเงินกลับบริษัท และดูยอดคงเหลือกับความเคลื่อนไหว" },
  ...
  { href: "/procurement/setup/funds", menuCode: "PR_FUND", title: "ตั้งค่า วงเงินสำรองจ่าย", desc: "ตั้งเพดานเงินสำรองให้ผู้ถือเงินเป็นรายคน พร้อมดูยอดคงเหลือของแต่ละกอง" },
