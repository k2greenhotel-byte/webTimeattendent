...
const SHORTCUTS = [
  ...
  {
    href: "/core/program-rights",
    title: "4. กำหนดสิทธิ์เมนูในโปรแกรม",
    desc: "เลือกโปรแกรม → คนที่มีสิทธิ์เข้า (ตามเมนู 5) → เข้าเมนูไหนได้ อ่าน/เพิ่ม/แก้ไข/ลบ อะไรได้ (ค่าเริ่มต้นตามระดับเป็นแม่แบบ)",
  },
  {
