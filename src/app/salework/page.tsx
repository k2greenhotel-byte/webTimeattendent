...
const MENUS = [
  ...
  // เมนูข้ามโปรแกรม (ระบบอนุมัติกลาง) — พนักงานขายใช้บ่อยคู่กับงานประจำวัน
  // เช่น ขอสลับกะ ขอลา จึงวางไว้ให้กดได้จากหน้าแรกของโปรแกรมนี้เลย
  {
    menuCode: "APV_NEW",
    href: "/approvals/new",
    title: "ยื่นเรื่องขออนุมัติ",
    description: "ขอสลับกะ ขอลา ขอส่วนลด หรือเรื่องอื่น ส่งตรงถึงผู้มีอำนาจอนุมัติ",
  },
];
