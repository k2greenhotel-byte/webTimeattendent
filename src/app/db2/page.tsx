...
const MENUS = [
  ...
  {
    menuCode: "DB2_STOCK_WALL",
    href: "/db2/stock/wall",
    title: "9. จอ War Room สต็อกรถ",
    description:
      "เปิดค้างบนจอมอนิเตอร์ — คงเหลือ/มูลค่าต้นทุน อายุสต็อก อันดับตามยี่ห้อ/รุ่น/สาขา และตารางไขว้ กรองสาขา/สภาพรถได้ รีเฟรชเองทุกนาที",
  },
];
